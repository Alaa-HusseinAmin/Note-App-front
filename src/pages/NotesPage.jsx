import {
  Box, Button, Grid, IconButton, Input, Modal, ModalBody,
        ...
        >
          ...
          <ModalContent>
            ...
            <ModalBody pb={6}>
                ...
                <Textarea mt={8} value={content} placeholder={'Please enter description'} onChange={(e)=>setContent(e.target.value)}></Textarea>
